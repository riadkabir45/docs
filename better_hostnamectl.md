...
One can update these file manually but a lot of services require a sync trigger to know hostname is update. So instead of updaing the /etc/hostname manually, it is better to call `hostnamectl`
